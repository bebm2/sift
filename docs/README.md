...
| `WBS.md` | 里程碑、任务分解、验收标准 | 具体执行步骤（那是 `plans/`） |
...
- `reviews/`：`YYYY-MM-DD-主题-NN.md`，同日多份用序号保持轮次顺序（如 `2026-07-27-prd-review-03.md`）。
...
- 单文件聚焦单一主题；超过约 300 行考虑按子主题拆分，用索引文件串起来。
