...
func TestSchemaInventory(t *testing.T) {
	...
	wantIndexes := []string{
		...
		"intake_items_state_updated", "gate_evaluations_run_created", "ledger_entries_run_created", "proposal_drafts_aggregate_created", "report_quota_exhaustions_run_bucket",
	}
